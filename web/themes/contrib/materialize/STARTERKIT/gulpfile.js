...
// #############################
options.materialize = {
  css: 'materialize-v0.99.0.zip',
  src: 'materialize-src-v0.99.0.zip',
  zip: 'materialize-src-v0.99.0.zip',
  url: 'https://github.com/Dogfalo/materialize/releases/download/v0.99.0/'
}
